...
export default function EditProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 p-4">
      <div className="bg-zinc-950 rounded-2xl w-full max-w-md shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        ...
        <div className="overflow-y-auto flex-1 p-0">
          ...
          {/* Cover Photo */}
          <div
            className="relative h-32 bg-zinc-800 w-full group cursor-pointer"
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
              ...
              <span className="text-zinc-50 text-sm font-semibold ml-2">
                Change Cover
              </span>
            </div>
            <input
